...
set_up = _device.set_up

def tear_down():
    return _device.tear_down()
tear_down = _device.tear_down
class Motor(_object):
    __swig_setmethods__ = {}
...
Motor_swigregister = _device.Motor_swigregister
...
class RotaryEncoder(_object):
    ...
    def __init__(self, pin_a, pin_b):
        this = _device.new_RotaryEncoder(pin_a, pin_b)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
RotaryEncoder_swigregister = _device.RotaryEncoder_swigregister
